...
let y$1 = class y extends HTMLElement {
    ...
    requestUpdate(t, s, i) {
        if (void 0 !== t) {
            ...
            !((i.hasChanged ?? f$3)(h, s) || i.useDefault && i.reflect && h === this._$Ej?.get(t) && !this.hasAttribute(e._$Eu(t, i))))
                return;
            this.C(t, s, i)
        }
    ...
    C(t, s, {useDefault: i, reflect: e, wrapped: h}, r) {
        i && !(this._$Ej ??= new Map).has(t) && (this._$Ej.set(t, r ?? s ?? this[t]),
        !0 !== h || void 0 !== r) || (this._$AL.has(t) || (this.hasUpdated || i || (s = void 0),
        this._$AL.set(t, s)),
...
const t$2 = globalThis
  ...
  , s$2 = i$2 ? i$2.createPolicy("lit-html-desktop", {
    createHTML: t => t
}) : void 0
  , e$1 = "$lit$"
...
const V = (t, i) => {
    ...
    for (let i = 0; i < s; i++) {
        ...
        null !== u); )
            y = c.lastIndex,
            c === f$2 ? "!--" === u[1] ? c = v : void 0 !== u[1] ? c = _ : void 0 !== u[2] ? ($.test(u[2]) && (r = RegExp("</" + u[2], "g")),
            c = m) : void 0 !== u[3] && (c = m) : c === m ? ">" === u[0] ? (c = r ?? f$2,
            d = -1) : void 0 === u[1] ? d = -2 : (d = c.lastIndex - u[2].length,
            a = u[1],
            c = void 0 === u[3] ? m : '"' === u[3] ? g : p) : c === g || c === p ? c = m : c === v || c === _ ? c = f$2 : (c = m,
            r = void 0);
        const x = c === m && t[i + 1].startsWith("/>") ? " " : "";
        l += c === f$2 ? s + n$1 : d >= 0 ? (o.push(a),
        s.slice(0, d) + e$1 + s.slice(d) + h$1 + x) : s + h$1 + (-2 === d ? i : x)
    }
...
class N {
    constructor({strings: t, _$litType$: s}, n) {
        ...
        const u = t.length - 1
          , d = this.parts
          , [f,v] = V(t, s);
        if (this.el = N.createElement(f, n),
...
class M {
    ...
    u(t) {
        ...
        for (; void 0 !== l; ) {
            ...
            o !== l?.index && (h = C.nextNode(),
            o++)
        }
        return C.currentNode = r$1,
        e
    }
    p(t) {
        let i = 0;
...
class R {
    ...
    _$AI(t, i=this) {
        t = S(this, t, i),
        c$1(t) ? t === E || null == t || "" === t ? (this._$AH !== E && this._$AR(),
        this._$AH = E) : t !== this._$AH && t !== T && this._(t) : void 0 !== t._$litType$ ? this.$(t) : void 0 !== t.nodeType ? this.T(t) : u(t) ? this.k(t) : this._(t)
    }
    O(t) {
    ...
    _(t) {
        this._$AH !== E && c$1(this._$AH) ? this._$AA.nextSibling.data = t : this.T(r$1.createTextNode(t)),
        this._$AH = t
    }
    $(t) {
        const {values: i, _$litType$: s} = t
          , e = "number" == typeof s ? this._$AC(t) : (void 0 === s.el && (s.el = N.createElement(P(s.h, s.h[0]), this.options)),
        s);
        if (this._$AH?._$AD === e)
            this._$AH.p(i);
        else {
    ...
    _$AC(t) {
        ...
        return void 0 === i && A.set(t.strings, i = new N(t)),
        i
    }
    k(t) {
        ...
        let s, e = 0;
        for (const h of t)
            e === i.length ? i.push(s = new R(this.O(l()),this.O(l()),this,this.options)) : s = i[e],
            s._$AI(h),
            e++;
...
j?.(N, R),
(t$2.litHtmlVersions ??= []).push("3.3.0");
const B = (t, i, s) => {
...
class NightMode {
    ...
    placeStars() {
        ...
        for (let i = 0; i < Config.NUM_STARS; i++) {
            ...
            if (IS_HIDPI) {
                starPosition.sourceY = spriteDefinitionByType.original.hdpi.star.y + Config.STAR_SIZE * 2 * i
            } else {
...
class Horizon {
    ...
    constructor(canvas, spritePos, dimensions, gapCoefficient) {
        ...
        for (let i = 0; i < runnerSpriteDefinition.lines.length; i++) {
            this.horizonLines.push(new HorizonLine(this.canvas,runnerSpriteDefinition.lines[i]))
        }
...
class Runner {
    ...
    init() {
        ...
        if (this.isArcadeMode()) {
            document.title = document.title + " - " + getA11yString(A11yStrings.ARIA_LABEL)
        }
    ...
    gameOver() {
        ...
        if (!this.gameOverPanel) {
            ...
            if (this.canvas) {
                if (this.isAltGameModeEnabled()) {
                    this.gameOverPanel = new GameOverPanel(this.canvas,origSpriteDef.textSprite,origSpriteDef.restart,this.dimensions,origSpriteDef.altGameEnd,this.altGameModeActive)
                } else {
                    this.gameOverPanel = new GameOverPanel(this.canvas,origSpriteDef.textSprite,origSpriteDef.restart,this.dimensions)
                }
            }
        }
...
function shouldShowSuggestionsSummaryList(data) {
    return !!data.suggestionsSummaryList && data.suggestionsSummaryList.length > 0
}
